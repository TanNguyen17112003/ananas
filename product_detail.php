                ...
                <div class="container pb-5">
                    <div class="row">
                        <div class="col-lg-6 mt-5">
                            <div class="card mb-3">
                                <img class="card-img rounded img-fluid" id="product-detail" alt="bla" src="./public/img/<?php echo $row["images"] ?>">
                            </div>
                            <div class="row">
                                <div id="multi-item-example" class="carousel slide carousel-multi-item" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner product-links-wap" role="listbox">
                                        ...
                                        <div class="carousel-item active">
                                            <div class="row">
                                                <div class="col-3">
                                                    <img class="sub_image card-img img-fluid" src="./public/img/<?php echo $row["subimg_1"] ?>" alt="Product Image 1">
                                                </div>
                                                <div class="col-3">
                                                    <img class="sub_image card-img img-fluid" src="./public/img/<?php echo $row["subimg_2"] ?>" alt="Product Image 2">
                                                </div>
                                                <div class="col-3">
                                                    <img class="sub_image card-img img-fluid" src="./public/img/<?php echo $row["subimg_3"] ?>" alt="Product Image 3">
                                                </div>
                                                <div class="col-3">
                                                    <img class="sub_image card-img img-fluid" src="./public/img/<?php echo $row["images"] ?>" alt="Product Image 3">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h2 style="color:#002A54"><?php echo $row["name"]; ?> <span class="text-secondary">#<?php echo $row["product_id"]; ?></span></h2>
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    ?>
                                        <div class="pb-3">
                                            <span class="badge bg-success" id="product-quantity">Còn <?php echo $row['quantity'] ?> sản phẩm </span>
                                        </div>
                                    <?php
                                    } else {
                                    ?>
