    ...
    <div class="container pt-5 pb-5">
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" class="row">
            <div class="col-xl-8 col-md-6 col-sm-12 shadow-sm p-3 mb-5 bg-body rounded">
                ...
                <input type="text" class="form-control mb-2" name="addressReceiver"
                        ...
                        ?>
                            <li class="list-group-item">
                                <p class="d-flex justify-content-between">
                                    ...
                                    <span class="text-danger"><strong><?=number_format($totalBill)?>
                        ...
                        <ul class="list-group">
                            <li class="list-group-item">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="paymentMethod" value="tienMat"
                                        id="tienMat" checked>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="paymentMethod" value="ATM"
                                        id="ATM">
                                ...
                                <p>
                                    ...
                                    <button type="submit" name="order" class="btn btn-primary w-100"><i
                                            class="fa-regular fa-money-bill-wave"></i> <strong>Thanh
                                            toán</strong></button>
                                </p>
                            </li>
                        </ul>
