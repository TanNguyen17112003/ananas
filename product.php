...
<body>
    ...
    <div class="mt-lg-5 mb-lg-5">
        <div class="row">
            <div class="col-lg-3">
                <div class="dropdown-toggle list text-decoration-none text-white p-4 bg-black d-lg-none"
                ...
                <div class="px-4 collapse-option" id="collapseOptions">
                    <div class="mb-5">
                        ...
                        <ul class="collapse list-unstyled" id="collapseStyle">
                            ...
                            ?>
                            <a class="text-decoration-none text-black font-weight-bold"
                    ...
                    <div class=" mb-5">
                        ...
                        <ul class="collapse list-unstyled" id="collapseProductLine">
                            <a class="text-decoration-none text-black font-weight-bold"
                                href="<?php echo $rootPath ?>/product.php?categoryId=<?php echo $row['id'] ?>">
                                <li class="mb-2">
                                    <div class="form-check d-flex items-center gap-2">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="styleCheck<?php echo $i ?>">
                    ...
                    <div class=" mb-5">
                        ...
                        <ul class="collapse list-unstyled" id="collapseCostRange">
                            ...
                            ?>
                            <a class="text-decoration-none text-black font-weight-bold"
                                href="<?php echo $rootPath ?>/product.php?categoryId=<?php echo $row['range_id'] ?>">
                                <li class="mb-2">
                                    <div class="form-check d-flex items-center gap-2">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="styleCheck<?php echo $i ?>">
                            ...
                            <nav class="pagination-outer" aria-label="Page navigation">
                                <ul class="pagination">
                                    <li class="page-item <?= ($page == 1) ? 'disabled' : '' ?>">
                                        <a href="product.php?page=<?= $Previous; ?>" aria-label="Previous"
                                            class="page-link">
                                    ...
                                    <li class="page-item <?= ($i == $page) ? 'active' : '' ?>"><a
                                            href="product.php?page=<?= $i; ?>" class="page-link"><?= $i; ?></a></li>
                                    <?php endfor; ?>
