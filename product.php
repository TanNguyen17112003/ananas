    ...
    <div class="mt-lg-5 mb-lg-5">
        <div class="row">
            <div class="col-lg-3 row p-lg-3 p-sm-0 container">
                <div class="col-6 dropdown-toggle list text-decoration-none text-white text-lg-black p-4 bg-black bg-lg-white d-lg-none"
                ...
                <div class="col-6 text-black p-4 d-lg-none text-white bg-black"
                    style="text-align: right; border-left: 1px solid #ddd ">
                    <span class="align-middle font-weight-bold" style="font-size: 1.5rem; font-weight: bold"><?= $total ?> sản phẩm</span>
                </div>
