      ...
      <div class="col-12 col-lg-6">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            ...
            <p class="lead fs-4 text-secondary mb-5">Khách hàng là thượng đế. Nếu bạn quan tâm hay gặp bất kỳ vấn đề gì trong quá trình trải nghiệm và sử dung sản phẩm. Hãy liên hệ với chúng tôi.</p>
            <div class="d-flex mb-5">
              ...
              <div>
                ...
                <address class="mb-0 text-secondary">Đại học Bách Khoa, Bình Dương, Việt Nam</address>
              </div>
            </div>
            <div class="row mb-5">
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-5 mb-sm-0">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="tel:+15057922430">086.289.8859</a>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-0">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">duytan17112003@gmail.com</a>
                    </p>
                  </div>
                </div>
              </div>
