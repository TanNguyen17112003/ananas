        ...
        <div class="carousel-inner ">
            <div class="carousel-item active" data-bs-interval="3000">
                <img class="d-block mx-auto img-fluid"
                    src="https://ananas.vn/wp-content/uploads/Hi-im-Mule_1920x1050-Desktop.jpg" alt="First slide" />
            </div>
            <div class="carousel-item" data-bs-interval="3000">
                <img class="d-block mx-auto img-fluid" src="https://ananas.vn/wp-content/uploads/Web1920-1.jpeg"
                    alt="First slide" />
            </div>
            <div class="carousel-item" data-bs-interval="3000">
                <img class="d-block mx-auto img-fluid"
                    src="https://ananas.vn/wp-content/uploads/kv_basas_mobileBanner_4_2019.jpg" alt="First slide" />
            ...
            <div class="row">
                <div class="col-xl-3 col-md-6 col-sm-12 shadow-sm">
                    <div class="text-center card border border-2  card-info">
                        <a href="https://www.facebook.com/tan.nguyenhoangduy.374"><img alt="AVT" width="200" height="200"
                ...
                <div class="col-xl-3 col-md-6 col-sm-12 shadow-sm">
                    <div class="text-center card border border-2  card-info">
                        <a href="https://www.facebook.com/profile.php?id=100008620419001"><img alt="AVT" width="200"
                                height="200" src="./assets/tue_avt.jpg" class="rounded-circle mb-3 mt-3" /></a>
                ...
                <div class="col-xl-3 col-md-6 col-sm-12 shadow-sm">
                    <div class="text-center card border border-2 card-info">
                        <a href="https://www.facebook.com/huytran613"><img alt="AVT" width="200" height="200"
                                src="./assets/huy_avt.jpg" class="rounded-circle mb-3 mt-3" /></a>
    ...
    <div>
        ...
        <div class="row container-fluid">
            ...
            <div class="col-lg-3 col-sm-6 mb-3">
                <a href="<?php echo $rootPath ?>/product_detail.php?productId=<?php echo $newArrivalProductRow['product_id']?>"
                    class="text-black text-decoration-none">
                    <div class="card h-100 position-relative">

                        <img src="<?php echo $rootPath ?>/public/img/<?php echo $newArrivalProductRow['images']; ?>"
                            class="img-fluid" alt="..."
                            onmouseover="this.src='<?php echo $rootPath ?>/public/img/<?php echo $newArrivalProductRow['subimg_1'];?>'"
                            onmouseout="this.src='<?php echo $rootPath ?>/public/img/<?php echo $newArrivalProductRow['images'];?>'">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between align-items-center">
                            <div class="d-flex flex-column justify-content-start">
                                <h6 class="card-title" style="font-size: 0.75rem">
                                    <?php echo $newArrivalProductRow["name"]; ?></h6>
                            </div>
                            <div class="card-text">
                                <p>
                                    <?php
